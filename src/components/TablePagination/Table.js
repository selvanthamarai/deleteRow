      ...
      <Table>
...

        {
          props.rows.map((data, index) => {
            ...
            console.log("hii world", props);
            return (

              <TableRow >

                <TableCell align="center">
                  <Textfield id="expdate" autoComplete="expname" variant="outlined" sms="15" formate="" type="date" />
                </TableCell>
                <TableCell align="center">
                  <Textfield id="expdate" autoComplete="expname" variant="outlined" sms="15" formate="" />
                </TableCell>
                <TableCell align="center">
                  <Textfield id="expdate" autoComplete="expname" variant="outlined" sms="15" formate="" />
                </TableCell>
                ...
                <TableCell align="center">
                  {/* <IconButton aria-label="Delete" className={classes.margin}  onClick={props.delete}> */}
                  <IconButton aria-label="Delete" className={classes.margin} onClick={props.delete}>
...
//           <TableRow>
//           <TableCell class="col-sm-3"></TableCell>
//             <TableCell class="col-sm-1">   <Textfield id="expdesc" autoComplete="expdes" variant="outlined" sms="11" />   </TableCell>
//             <TableCell class="col-sm-1"> <Textfield id="expdesc" autoComplete="expdes" variant="outlined" sms="11" /></TableCell>
//             <TableCell class="col-sm-1"> <Textfield id="expdesc" autoComplete="expdes" variant="outlined" sms="11" /></TableCell>
//             <TableCell class="col-sm-1"> <Textfield id="expdesc" autoComplete="expdes" variant="outlined" sms="11" /></TableCell>
...
{/* <TableRow >
             ...
             <TableCell align="center">
             <input id="expdate" autoComplete="expdes" variant="outlined" sms="" /> 
             </TableCell> 
             <TableCell align="center">
             <input id="expdesc" autoComplete="expdes" variant="outlined" sms="auto" /> 
             </TableCell>
             <TableCell align="center">
             <input id="expdesc" autoComplete="expdes" variant="outlined" sms="auto" /> 
             </TableCell>
...
{/* <TableRow > */ }
{/* <TableCell align="center" class="col-sm-3"></TableCell>  */ }
{/* <TableCell align="center" >
              <Textfield  id="expdate"  autoComplete="expname" variant="outlined" sms="9" formate="" type="date" /> 
              </TableCell> 
              <TableCell align="center" >
              <Textfield id="expdesc" autoComplete="expdes" variant="outlined" sms="15" /> 
              </TableCell> 
              <TableCell align="center" >
              <Textfield id="expdesc" autoComplete="expdes" variant="outlined" sms="20" /> 
              </TableCell>
              <TableCell align="center" >
              <Textfield id="expdesc" autoComplete="expdes" variant="outlined" sms="30" /> 
              </TableCell> */}
{/* <TableCell align="center" class="col-sm-3"></TableCell>  */ }
{/* </TableRow> */ }